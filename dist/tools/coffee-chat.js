...
export function registerCoffeeChatTools(server) {
    server.addTool({
        name: "find_coffee_contacts",
        description: "Find people available for coffee chats / networking. Use this when the user wants to connect with professionals, find mentors, or network in a specific industry.",
        parameters: z.object({
        ...
        execute: async (args, context) => {
            ...
            if (args.industry)
                params.append("industry", args.industry);
            if (args.help_topics) {
    ...
    server.addTool({
        ...
        description: "Send a coffee chat request to a user. Use this after finding contacts with find_coffee_contacts.",
        parameters: z.object({
    ...
    server.addTool({
        ...
        execute: async (_args, context) => {
            ...
            const p = data.data;
            if (!p)
                return "No coffee chat profile found.";
            return [
                `Coffee Chat Profile`,
    ...
    server.addTool({
        ...
        execute: async (args, context) => {
            ...
            if (args.help_topics)
                body.helpTopics = args.help_topics;
            if (args.years_experience !== undefined)
